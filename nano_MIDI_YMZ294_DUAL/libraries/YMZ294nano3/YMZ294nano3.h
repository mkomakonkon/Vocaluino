...
#ifndef YMZ294nano3_H
#define YMZ294nano3_H

#include "Arduino.h"

// YMZ294nano3 Registers
#define	REG_A_L	0x00
#define	REG_A_H	0x01
#define	REG_B_L	0x02
#define	REG_B_H	0x03
...
class YMZ294nano3 {
public:
		YMZ294nano3(byte wrcs0_pin, byte wrcs1_pin, byte a0_pin, byte reset_pin);
