...
MIDI_CREATE_DEFAULT_INSTANCE();
  ...
  int Bass_Drum     = 0b0111111;  // Bass_Drum用アサイン PC5(Nanoのポート番号)
  int Snare_Drum    = 0b1011111;  // Snare Drum用アサイン PC4
  int Low_Tom       = 0b1101111;  // Low_Tom用アサイン PC3
  int High_Tom      = 0b1110111;  // High_Tom用アサイン PC2
  int Cymbal        = 0b1111011;  // Crash_Cymbal用アサイン PC1
  int Open_Hi_Hat   = 0b1111101;  // Open_Hi_Hat用アサイン PC0
  int Closed_Hi_Hat = 0b1111110;  // Closed_Hi_Hat用アサイン PB5
 
  int No_assign     = 0b1111111;  // アサイン無し
...
Closed_Hi_Hat, //NOTE_CS2,No_37,Side_Stick,
Snare_Drum, //NOTE_D2,No_38,Snare_Drum,通常
Closed_Hi_Hat, //NOTE_DS2,No_39,Hand_Crap,
Snare_Drum, //NOTE_E2,No_40,Snare_Drum,Electric
Low_Tom, //NOTE_F2,No_41,Floor_Tom,ﾛｰﾌﾛｱ
Closed_Hi_Hat, //NOTE_FS2,No_42,Closed_Hi_Hat,クローズ
Low_Tom, //NOTE_G2,No_43,Floor_Tom,ﾊｲﾌﾛｱ
...
Closed_Hi_Hat, //NOTE_GS3,No_56,Cowbell,
...
No_assign, //NOTE_D4,No_62,High_Conga,ミュート
No_assign, //NOTE_DS4,No_63,High_Conga,オープン
No_assign, //NOTE_E4,No_64,Low_Conga,
No_assign, //NOTE_F4,No_65
No_assign, //NOTE_FS4,No_66
No_assign, //NOTE_G4,No_67,Agogo,Hi
No_assign, //NOTE_GS4,No_68,Agogo,Low
